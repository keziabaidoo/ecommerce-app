...
class MainContent extends Component {
  state = { pageTitle: "employees", customersCount: 5 , customers:[ 
     {id:1, name:"Sam", phone:"020335679",address:{city:"Berlin"}},
     {id:1, name:"Jones", phone:"05435672",address:{city:"Germany"}},
     {id:1, name:"Evans", phone:"024335678",address:{city:"London"}},
     {id:1, name:"Paul", phone:"056335674",address:{city:"Italy"}},
